<%-- 
    Document   : customers
    Created on : 28-Sept-2025, 2:58:41 pm
    Author     : chanc
--%>
...
<head>
    ...
    <title>Suppliers - DairyTrack</title>
...
<div class="dashboard-container">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="FarmerServlet" class="active">Suppliers</a></li>
    ...
    <main class="main-content">
        ...
        <div class="search-bar">
            <form method="get" action="FarmerServlet">
        ...
        <table class="data-table">
            ...
            %>
                <tr>
                    ...
                    <td><%= f.getEmail() %></td>
                    <td>
                        <a href="FarmerServlet?action=edit&id=<%=f.getFarmerId()%>" class="action-icon">✎</a>
...
<div id="addCustomerModal" class="modal-overlay" style="display:none;">
    <div class="modal-content">
        <div class="modal-header">
            <div>
                <h3>Add New Customer/Supplier</h3>
                <p>Enter the details to register a new customer or supplier</p>
            </div>
        ...
        <form class="modal-form" method="post" action="AddServlet">
            ...
            <div class="input-group">
                ...
                <select id="type" name="type">
                    <option value="supplier" <%= "supplier".equals(request.getParameter("type")) ? "selected" : "" %>>Supplier</option>
                </select>
            </div>
